error id: file://<WORKSPACE>/app/repositories/ProductRepository.java
file://<WORKSPACE>/app/repositories/ProductRepository.java
...
```java
offset: 891
uri: file://<WORKSPACE>/app/repositories/ProductRepository.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/app/repositories/ProductRepository.java