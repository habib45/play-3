error id: file://<WORKSPACE>/app/controllers/ProductController.java
file://<WORKSPACE>/app/controllers/ProductController.java
...
```java
offset: 0
uri: file://<WORKSPACE>/app/controllers/ProductController.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/app/controllers/ProductController.java