error id: file://<WORKSPACE>/app/models/Product.scala:toArray
file://<WORKSPACE>/app/models/Product.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol toArray
offset: 952
...
object Product extends Finder[Long, Product](classOf[Product]) {
  ...
  def all(): List[Product] = find.all().to@@Array.toList.asInstanceOf[List[Product]]
  def byId(id: Long): Option[Product] = Option(find.byId(id))
}
